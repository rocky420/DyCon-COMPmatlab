...
void InitializeModule_ylabel(void) {
...
void TerminateModule_ylabel(void) {
...
static mxArray * Mylabel(int nargout_, mxArray * string, mxArray * varargin) {
    mexLocalFunctionTable save_local_function_table_
      = mclSetCurrentLocalFunctionTable(&_local_function_table_ylabel);
    ...
    mclValidateOutput(hh, 1, nargout_, "hh", "ylabel");
    mxDestroyArray(ans);
    mxDestroyArray(ax);
    mxDestroyArray(h);
    mxDestroyArray(varargin);
