...
void InitializeModule_cont_2d(void) {
...
void TerminateModule_cont_2d(void) {
...
static mxArray * Mcont_2d(mxArray * * Test,
                          mxArray * * temps,
                          mxArray * * ek01,
                          mxArray * * ek11,
                          int nargout_,
...
_mexLocalFunctionTable _local_function_table_cont_2d
  = { 0, (mexFunctionTableEntry *)NULL };

/*
 * The function "mlfCont_2d" contains the normal interface for the "cont_2d"
 * M-function from file "c:\documents and settings\miguel cea nogal\mis
 * documentos\documents\progcontrol\guide6\cont_2d.m" (lines 1-449). This
 * function processes any input arguments and passes them to the implementation
 * version of the function, appearing above.
 */
mxArray * mlfCont_2d(mxArray * * Test,
                     mxArray * * temps,
                     mxArray * * ek01,
                     mxArray * * ek11,
                     mxArray * a,
...
/*
 * The function "mlxCont_2d" contains the feval interface for the "cont_2d"
 * M-function from file "c:\documents and settings\miguel cea nogal\mis
 * documentos\documents\progcontrol\guide6\cont_2d.m" (lines 1-449). The feval
 * function calls the implementation version of cont_2d through this function.
 * This function processes any input arguments and passes them to the
 * implementation version of the function, appearing above.
 */
void mlxCont_2d(int nlhs, mxArray * plhs[], int nrhs, mxArray * prhs[]) {
    mxArray * mprhs[8];
    mxArray * mplhs[5];
    int i;
    if (nlhs > 5) {
        mlfError(
          mxCreateString(
            "Run-time Error: File: cont_2d Line: 34 Column:"
            " 1 The function \"cont_2d\" was called with mo"
...
/*
 * The function "Mcont_2d" is the implementation version of the "cont_2d"
 * M-function from file "c:\documents and settings\miguel cea nogal\mis
 * documentos\documents\progcontrol\guide6\cont_2d.m" (lines 1-449). It
 ...
 * % ek01 =  data e^0_0 in step k
 * % ek11 =  data e^1_0 in step k      
 * 
 * function [controlex,Test,temps,ek01,ek11]=cont_2d(a,b,J,mu,T,epstest,U01,U11)
 */
static mxArray * Mcont_2d(mxArray * * Test,
                          mxArray * * temps,
                          mxArray * * ek01,
    ...
    mexLocalFunctionTable save_local_function_table_
      = mclSetCurrentLocalFunctionTable(&_local_function_table_cont_2d);
    mxArray * controlex = NULL;
    mxArray * time2 = NULL;
    ...
    mclValidateOutput(controlex, 1, nargout_, "controlex", "cont_2d");
    mclValidateOutput(*Test, 2, nargout_, "Test", "cont_2d");
    mclValidateOutput(*temps, 3, nargout_, "temps", "cont_2d");
    mclValidateOutput(*ek01, 4, nargout_, "ek01", "cont_2d");
    mclValidateOutput(*ek11, 5, nargout_, "ek11", "cont_2d");
    mxDestroyArray(ans);
